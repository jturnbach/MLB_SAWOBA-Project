...
# Save files
write.csv(sc_2020, "project/volume/data/raw/sc_2020.csv", row.names = FALSE)
write.csv(sc_2021, "project/volume/data/raw/sc_2021.csv", row.names = FALSE)
write.csv(sc_2022, "project/volume/data/raw/sc_2022.csv", row.names = FALSE)
write.csv(sc_2023, "project/volume/data/raw/sc_2023.csv", row.names = FALSE)